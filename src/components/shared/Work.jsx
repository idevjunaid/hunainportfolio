              ...
              >
                <Box sx={{
                  ...
                  >
                    ...
                    >
                      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="remixicon "><path d="M16.0037 9.41421L7.39712 18.0208L5.98291 16.6066L14.5895 8H7.00373V6H18.0037V17H16.0037V9.41421Z"></path></svg>
                    </IconButton>
                  </Box>
                </Box>
                <CardContent sx={{ p: 2, textAlign: 'left', backgroundColor: '#121214' }}>
                  <Typography
                    variant="caption"
                    sx={{
                      color: '#77777d',
